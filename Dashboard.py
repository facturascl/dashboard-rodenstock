# ============================================================================
# DASHBOARD RODENSTOCK - LANDING PAGE (SPA VERSION)
# Uses Plotly visualizations from repo-github/app.py
# ============================================================================
...
# ============================================================
# SECCIÓN 1: COMPARATIVA ANUAL (12 MESES)
# ============================================================
st.header("📊 Comparativa de Años", anchor="comparacion-anual")
...
# ============================================================
# SECCIÓN 2: DESGLOSE SUBCATEGORÍAS
# ============================================================
st.header(f"🏷️ Desglose Subcategorías - Año {ano_actual}", anchor="desglose-subcategorias")
...
# ============================================================
st.header(f"📈 Evolución Mensual - Año {ano_actual}", anchor="evolucion-mensual")
...
# ============================================================
# SECCIÓN 4: NOTAS DE CRÉDITO
# ============================================================
st.header("📋 Notas de Crédito", anchor="notas-de-credito")
